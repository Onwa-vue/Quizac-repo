                           ...
                           <span class="row_count"></span>
                            <div class="row_content">
                                ...
                                <div class="form-group">
                                    <Selectize class="form-control sel_multiple" multiple="multiple" v-model="selectedCountries" :settings="Countrysettings" v-validate="'required'" >
                           ...
                           <span class="row_count"></span>
                            <div class="row_content">
                               <header class="row_header">
                                ...
                                <div class="form-group">
                                    <selectize class="form-control sel_multiple" placeholder="Select your class(es) of interest" multiple="multiple" v-model="selectedLevels" :settings="{}" v-validate="'required'" >
                            ...
                            <div class="row_content">
                               <header class="row_header">
                                ...
                                <div class="form-group">
                                    ...
                                    <selectize class="form-control sel_multiple" placeholder="Select your subjects of interest" multiple="multiple" v-model="selectedSubjects" v-validate="'required'">
                           ...
                           <span class="row_count"></span>
                            <div class="row_content">
                               <header class="row_header">
                                ...
                                <div class="form-group">
                                    <select class="form-control" placeholder="Select your subjects of interest" v-model="language" v-validate="'required'">
                        ...
                        <div class="container content_narrow">
                            <div class="nav_flex_row">
                                ...
                                <div class="nav_btn btn-next">
                                    <button class="btn btn-primary" v-on:click="submit">Continue</button>
                                </div>
                            </div>
                        </div>
                    </div>
